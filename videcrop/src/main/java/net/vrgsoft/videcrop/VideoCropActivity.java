...
public class VideoCropActivity extends AppCompatActivity implements VideoPlayer.OnProgressUpdateListener, VideoSliceSeekBarH.SeekBarChangeListener {
    ...
    String OutputpathConvert = "/storage/emulated/0/Download/OutputpathC.mp4";
...
//        }
    ...
    private void handleCropStart(String uri) {
        ...
        if (mFFMpeg.isSupported()) {
            ...
            String croponly = String.format("crop=%d:%d:%d:%d:exact=0", cropRect.right, cropRect.bottom, cropRect.left, cropRect.top);
            String crop_compress = String.format("crop=%d:%d:%d:%d:exact=0,scale=576:1024", cropRect.right, cropRect.bottom, cropRect.left, cropRect.top);
            String compress = String.format("scale=576:1024");
//            String crop_compress = String.format("crop=%d:%d:%d:%d:exact=0,scale=648:1152", cropRect.right, cropRect.bottom, cropRect.left, cropRect.top);
            ...
            if (AspectRatio < 1.75    )
            {
//                Toast.makeText(VideoCropActivity.this, "AspectRatio is not 16:9", Toast.LENGTH_SHORT).show();
                ...
                if (videoHeight > 1024) {
                    ...
                    mFFTask = mFFMpeg.execute(cmd, new ExecuteBinaryResponseHandler() {
                        ...
                        public void onFailure(String message) {
                            Toast.makeText(VideoCropActivity.this, "Failed to crop & compress!!!", Toast.LENGTH_SHORT).show();
...
//
                        ...
                        public void onFinish() {
                            ...
                            mTvCropProgress.setText("0%");
//                            Toast.makeText(VideoCropActivity.this, "Finished crop & compressing", Toast.LENGTH_SHORT).show();
                        }
...
//                    };
                    ...
                    mFFTask = mFFMpeg.execute(cmd, new ExecuteBinaryResponseHandler() {
                        ...
                        @Override
                        public void onFailure(String message) {
                            Toast.makeText(VideoCropActivity.this, "Failed to compress!!!", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFinish() {
                            ...
                            square_bg.setVisibility(View.INVISIBLE);
                            mTvCropProgress.setText("0%");
//                            Toast.makeText(VideoCropActivity.this, "Finished compressing", Toast.LENGTH_SHORT).show();
...
//            mFFTask = mFFMpeg.execute(cmd1, new ExecuteBinaryResponseHandler() {
//                @Override
//                public void onSuccess(String message) {
//                    setResult(RESULT_OK);
//                    Log.e("onSuccess", message);
